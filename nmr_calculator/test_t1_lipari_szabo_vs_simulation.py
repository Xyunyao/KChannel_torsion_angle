...
def test_lipari_szabo_comparison():
    ...
    dt = 0.01e-12       # 0.01 ps time step (need fine sampling for fast tau_f)
    num_steps = 1000000 # 10 ns trajectory (need long enough to sample slow tau_c)
    max_lag = 500000    # Up to 5 ns lag (need at least 3×τc for proper decay)
